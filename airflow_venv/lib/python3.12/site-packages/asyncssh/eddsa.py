...
class _EdKey(SSHKey):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and self._key.private_value == other._key.private_value
        )
    ...
    def make_private(cls, key_params: object) -> SSHKey:
        ...
        try:
            ...
            return cls(EdDSAPrivateKey.construct(cls.algorithm[4:], private_value))
    ...
    def make_public(cls, key_params: object) -> SSHKey:
        ...
        try:
            ...
            return cls(EdDSAPublicKey.construct(cls.algorithm[4:], public_value))
        except (TypeError, ValueError):
    ...
    def encode_ssh_private(self) -> bytes:
        ...
        return b"".join(
            (
                ...
                String(self._key.private_value + self._key.public_value),
            )
        )
...
if ed448_available:  # pragma: no branch
    ...
    register_certificate_alg(
        1,
        b"ssh-ed448",
        b"ssh-ed448-cert-v01@openssh.com",
        _Ed448Key,
        SSHOpenSSHCertificateV01,
        True,
    )
