...
_mac_algs_list: Tuple[_MACAlgsArgs, ...] = ((b"", 0, 0, False, _NullMAC, (), True),)
...
for _alg, _key_size, _hash_size, _etm, _mac_alg, _args, _default in _mac_algs_list:
    register_mac_alg(_alg, _key_size, _hash_size, _etm, _mac_alg, _args, _default)
