...
def register_compression_alg(
    alg: bytes,
    compressor: _CompressorType,
...
register_compression_alg(b"none", _none, _none, False, True)
register_compression_alg(
    b"zlib@openssh.com", _ZLibCompress, _ZLibDecompress, True, True
)
register_compression_alg(b"zlib", _ZLibCompress, _ZLibDecompress, False, False)
