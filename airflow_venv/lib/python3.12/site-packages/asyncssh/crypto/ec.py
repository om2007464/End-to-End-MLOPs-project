...
class ECDSAPrivateKey(_ECKey):
    ...
    @classmethod
    def construct(
        cls, curve_id: bytes, public_value: bytes, private_value: int
    ) -> "ECDSAPrivateKey":
    ...
    def generate(cls, curve_id: bytes) -> "ECDSAPrivateKey":
        ...
        public_value = pub_key.public_bytes(
...
class ECDSAPublicKey(_ECKey):
    ...
    def construct(cls, curve_id: bytes, public_value: bytes) -> "ECDSAPublicKey":
        ...
        pub_key = ec.EllipticCurvePublicKey.from_encoded_point(curve(), public_value)
        pub = pub_key.public_numbers()
