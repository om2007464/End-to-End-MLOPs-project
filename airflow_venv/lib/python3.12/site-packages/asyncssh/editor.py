...
class SSHLineEditor:
    ...
    def __init__(
        self,
        chan: "SSHServerChannel[str]",
        session: "SSHServerSession[str]",
        line_echo: bool,
        history_size: int,
        max_line_length: int,
        term_type: str,
    ...
    def _determine_column(
        self, data: str, column: int, pos: Optional[int] = None
    ) -> Tuple[str, int]:
    ...
    def _end_line(self) -> None:
        ...
        need_wrap = (
            self._echo
            and not self._wrap
            and (self._left_pos > 0 or self._right_pos < len(line))
        )
    ...
    def register_key(self, key: str, handler: _KeyHandler) -> None:
        ...
        self._add_key(key, partial(SSHLineEditor._handle_key, key=key, handler=handler))
        self._build_printable()
...
class SSHLineEditorChannel:
    ...
    def __init__(
        self,
        orig_chan: "SSHServerChannel[str]",
    ...
    def set_line_mode(self, line_mode: bool) -> None:
        ...
        self._orig_chan.logger.info(
            "%s line editor", "Enabling" if line_mode else "Disabling"
        )
    ...
    def set_echo(self, echo: bool) -> None:
        ...
        self._orig_chan.logger.info("%s echo", "Enabling" if echo else "Disabling")
...
class SSHLineEditorSession:
    ...
    def __init__(
        self, chan: SSHLineEditorChannel, orig_session: "SSHServerSession[str]"
    ):
        self._chan = chan
        self._orig_session = orig_session
        self._editor: Optional[SSHLineEditor] = None
