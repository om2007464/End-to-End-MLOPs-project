...
class SSHSubprocessPipe(Generic[AnyStr]):
    ...
    def __init__(self, chan: "SSHClientChannel[AnyStr]", datatype: DataType = None):
...
class SSHSubprocessProtocol(Generic[AnyStr]):
    ...
    def connection_made(self, transport: "SSHSubprocessTransport[AnyStr]") -> None:
...
class SSHSubprocessTransport(SSHClientProcess[AnyStr]):
    ...
    def exit_signal_received(
        self, signal: str, core_dumped: bool, msg: str, lang: str
    ) -> None:
    ...
    def get_pipe_transport(self, fd: int) -> Optional[SSHSubprocessPipe[AnyStr]]:
