...
class GSSBase:
    ...
    def provides_mutual_auth(self) -> bool:
        ...
        return bool(self._ctx.actual_flags & RequirementFlag.mutual_authentication)
...
class GSSClient(GSSBase):
    ...
    def __init__(
        self, host: str, store: Optional[BytesOrStrDict], delegate_creds: bool
    ):
        super().__init__(host, store)

        flags = RequirementFlag.mutual_authentication | RequirementFlag.integrity
    ...
    def _init_context(self) -> None:
        ...
        self._ctx = SecurityContext(
            name=self._host, creds=self._creds, flags=self._flags
        )
