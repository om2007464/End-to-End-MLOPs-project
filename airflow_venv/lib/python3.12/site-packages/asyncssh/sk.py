...
def _ctap1_enroll(
    dev: "CtapHidDevice", alg: int, application: bytes
) -> Tuple[bytes, bytes]:
...
def _ctap1_sign(
    dev: "CtapHidDevice", message_hash: bytes, application: bytes, key_handle: bytes
) -> Tuple[int, int, bytes]:
...
def sk_enroll(
    alg: int, application: bytes, user: str, pin: Optional[str], resident: bool
) -> Tuple[bytes, bytes]:
...
def sk_sign(
    message_hash: bytes, application: bytes, key_handle: bytes, flags: int
) -> Tuple[int, int, bytes]:
...
def sk_get_resident(
    application: bytes, user: Optional[str], pin: str
