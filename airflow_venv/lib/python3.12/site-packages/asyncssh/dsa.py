...
class _DSAKey(SSHKey):
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and self._key.p == other._key.p
            and self._key.q == other._key.q
            and self._key.g == other._key.g
            and self._key.y == other._key.y
            and self._key.x == other._key.x
        )

    def __hash__(self) -> int:
        return hash((self._key.p, self._key.q, self._key.g, self._key.y, self._key.x))
    ...
    def decode_pkcs1_public(cls, key_data: object) -> Optional[_PublicKeyArgs]:
        ...
        if isinstance(key_data, tuple) and len(key_data) == 4 and all_ints(key_data):
            y, p, q, g = key_data
            return p, q, g, y
        else:
            return None
    ...
    def decode_pkcs8_private(
        ...
        if (
            ...
            and len(alg_params) == 3
            and all_ints(alg_params)
    ...
    def encode_pkcs1_private(self) -> object:
        ...
        return (0, self._key.p, self._key.q, self._key.g, self._key.y, self._key.x)
