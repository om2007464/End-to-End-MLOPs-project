...
from .py3 import (
    ...
    flatten as iflatten,
    mapcat as imapcat,
    distinct as idistinct,
    split as isplit,
    split_at as isplit_at,
    split_by as isplit_by,
    partition as ipartition,
    chunks as ichunks,
    partition_by as ipartition_by,
    reductions as ireductions,
    sums as isums,
    juxt as ijuxt,
    tree_leaves as itree_leaves,
    tree_nodes as itree_nodes,
    where as iwhere,
    pluck as ipluck,
    pluck_attr as ipluck_attr,
    linvoke as invoke,
)
