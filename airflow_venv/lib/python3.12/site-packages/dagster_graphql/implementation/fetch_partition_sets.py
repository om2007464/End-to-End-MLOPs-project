...
def get_partitions(
    ...
    partition_names = apply_cursor_limit_reverse(
        partition_names, cursor, limit, reverse
    )
...
def partition_statuses_from_run_partition_data(
    ...
    partition_data_by_name = {
        ...
        for partition_data in run_partition_data
    }
...
def partition_status_counts_from_run_partition_data(
    ...
    return [
        GraphenePartitionStatusCounts(runStatus=k, count=v)
