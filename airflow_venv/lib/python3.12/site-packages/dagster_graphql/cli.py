...
def execute_query_from_cli(
    workspace_process_context, query, variables=None, output=None
):
    check.inst_param(
        workspace_process_context, "workspace_process_context", WorkspaceProcessContext
    )
...
@click.option(
    ...
    "-t",
    type=click.STRING,
    help="GraphQL document to execute passed as a string",
)
@click.option(
    "--file",
    "-f",
    type=click.File(),
    help="GraphQL document to execute passed as a file",
)
@click.option(
    "--predefined",
    "-p",
