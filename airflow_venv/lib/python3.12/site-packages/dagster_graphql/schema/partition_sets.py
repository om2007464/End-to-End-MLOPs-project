...
class GraphenePartitionSet(graphene.ObjectType):
    ...
    partition = graphene.Field(
        GraphenePartition, partition_name=graphene.NonNull(graphene.String)
    )
    ...
    def resolve_backfills(
        ...
        matching = [
            ...
            == self._remote_partition_set.name
            ...
            [
                GrapheneDimensionDefinitionType(
                    ...
                    == cast(
                        ...
                        partition_def_data.get_partitions_definition(),
