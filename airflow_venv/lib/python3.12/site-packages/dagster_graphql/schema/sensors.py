...
class GrapheneSensor(graphene.ObjectType):
    ...
    def __init__(
        ...
        self._remote_sensor = check.inst_param(
        ...
        self._sensor_state = self._remote_sensor.get_current_instigator_state(
            sensor_state
        )
        ...
        super().__init__(
            ...
            metadata=GrapheneSensorMetadata(
                assetKeys=remote_sensor.metadata.asset_keys
                if remote_sensor.metadata
                else None
            ),
    ...
    def mutate(
        ...
        if id:
            ...
            raise DagsterInvariantViolationError(
                "Must specify id or jobOriginId and jobSelectorId"
            )
        else:
