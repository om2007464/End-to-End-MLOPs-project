...
class GrapheneResourceDetails(graphene.ObjectType):
    ...
    def __init__(
        ...
        self._remote_resource = check.inst_param(
            remote_resource, "remote_resource", RemoteResource
        )
    ...
    def resolve_nestedResources(
        self, graphene_info
    ) -> List[GrapheneNestedResourceEntry]:
    ...
    def resolve_assetKeysUsing(self, _graphene_info) -> List[GrapheneAssetKey]:
        return [
            ...
            for asset_key in self._asset_keys_using
        ]

    def resolve_jobsOpsUsing(
        self, graphene_info: ResolveInfo
    ) -> List[GrapheneJobAndSpecificOps]:
        return [
