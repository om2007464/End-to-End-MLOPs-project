...
alias_association_table = Table(
    ...
    Base.metadata,
    Column(
        "alias_id", ForeignKey("dataset_alias.id", ondelete="CASCADE"), primary_key=True
    ),
    Column(
        "dataset_id", ForeignKey("dataset.id", ondelete="CASCADE"), primary_key=True
    ),
...
dataset_alias_dataset_event_assocation_table = Table(
    ...
    Column(
        "event_id", ForeignKey("dataset_event.id", ondelete="CASCADE"), primary_key=True
    ),
...
class DatasetAliasModel(Base):
    ...
    consuming_dags = relationship(
        "DagScheduleDatasetAliasReference", back_populates="dataset_alias"
    )
