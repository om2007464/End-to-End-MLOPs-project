...
def upgrade():
    ...
    if conn.dialect.name == "mssql":
        ...
        with op.batch_alter_table("task_instance") as task_instance_batch_op:
            ...
            task_instance_batch_op.create_index(
                "ti_dag_date", ["dag_id", "execution_date"], unique=False
            )
        ...
        op.alter_column(
            table_name="log", column_name="dttm", type_=mssql.DATETIME2(precision=6)
        )
        ...
        with op.batch_alter_table("sla_miss") as sla_miss_batch_op:
            ...
            sla_miss_batch_op.alter_column(
                column_name="timestamp", type_=mssql.DATETIME2(precision=6)
            )
        ...
        op.alter_column(
            table_name="job", column_name="end_date", type_=mssql.DATETIME2(precision=6)
        )
        op.alter_column(
            table_name="job",
...
def downgrade():
    ...
    if conn.dialect.name == "mssql":
        ...
        with op.batch_alter_table("task_reschedule") as task_reschedule_batch_op:
            ...
            task_reschedule_batch_op.alter_column(
                column_name="start_date", type_=mssql.DATETIME
            )
            task_reschedule_batch_op.alter_column(
                column_name="end_date", type_=mssql.DATETIME
            )
            task_reschedule_batch_op.alter_column(
                column_name="reschedule_date", type_=mssql.DATETIME
            )
        ...
        with op.batch_alter_table("task_instance") as task_instance_batch_op:
            ...
            task_instance_batch_op.alter_column(
                column_name="queued_dttm", type_=mssql.DATETIME
            )
            task_instance_batch_op.create_index(
                "ti_state_lkp", ["dag_id", "task_id", "execution_date"], unique=False
            )
        ...
        with op.batch_alter_table("dag_run") as dag_run_batch_op:
            modify_execution_date_with_constraint(
                conn, dag_run_batch_op, "dag_run", mssql.DATETIME, None
            )
            dag_run_batch_op.alter_column(
                column_name="start_date", type_=mssql.DATETIME
            )
        ...
        with op.batch_alter_table("sla_miss") as sla_miss_batch_op:
            modify_execution_date_with_constraint(
                conn, sla_miss_batch_op, "sla_miss", mssql.DATETIME, False
            )
            sla_miss_batch_op.alter_column(
                column_name="timestamp", type_=mssql.DATETIME
            )

        op.drop_index("idx_task_fail_dag_task_date", table_name="task_fail")
        op.alter_column(
            table_name="task_fail", column_name="execution_date", type_=mssql.DATETIME
        )
        op.alter_column(
            table_name="task_fail", column_name="start_date", type_=mssql.DATETIME
        )
        op.alter_column(
            table_name="task_fail", column_name="end_date", type_=mssql.DATETIME
        )
        op.create_index(
            "idx_task_fail_dag_task_date",
            "task_fail",
        ...
        op.drop_index("idx_xcom_dag_task_date", table_name="xcom")
        op.alter_column(
            table_name="xcom", column_name="execution_date", type_=mssql.DATETIME
        )
        op.alter_column(
            table_name="xcom", column_name="timestamp", type_=mssql.DATETIME
        )
        op.create_index(
            "idx_xcom_dag_task_date",
            "xcom",
            ["dag_id", "task_ild", "execution_date"],
            unique=False,
        )

        op.alter_column(
            table_name="dag", column_name="last_scheduler_run", type_=mssql.DATETIME
        )
        op.alter_column(
            table_name="dag", column_name="last_pickled", type_=mssql.DATETIME
        )
        op.alter_column(
            table_name="dag", column_name="last_expired", type_=mssql.DATETIME
        )

        op.alter_column(
            table_name="dag_pickle", column_name="created_dttm", type_=mssql.DATETIME
        )

        op.alter_column(
            table_name="import_error", column_name="timestamp", type_=mssql.DATETIME
        )

        op.drop_index("job_type_heart", table_name="job")
        op.drop_index("idx_job_state_heartbeat", table_name="job")
        op.alter_column(
            table_name="job", column_name="start_date", type_=mssql.DATETIME
        )
        op.alter_column(table_name="job", column_name="end_date", type_=mssql.DATETIME)
        op.alter_column(
            table_name="job", column_name="latest_heartbeat", type_=mssql.DATETIME
        )
        op.create_index(
            "idx_job_state_heartbeat",
            "job",
...
def modify_execution_date_with_constraint(
    conn, batch_operator, table_name, type_, nullable
) -> None:
    """
