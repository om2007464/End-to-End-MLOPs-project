...
def upgrade():
    ...
    with op.batch_alter_table("dag_run", schema=None) as batch_op:
        ...
        batch_op.create_index(
            "idx_last_scheduling_decision", ["last_scheduling_decision"], unique=False
        )
    ...
    with op.batch_alter_table("dag", schema=None) as batch_op:
        ...
        batch_op.add_column(
            sa.Column("has_task_concurrency_limits", sa.Boolean(), nullable=True)
        )

        batch_op.create_index(
            "idx_next_dagrun_create_after", ["next_dagrun_create_after"], unique=False
        )
    ...
    with op.batch_alter_table("dag", schema=None) as batch_op:
        ...
        batch_op.alter_column(
            "has_task_concurrency_limits", type_=sa.Boolean(), nullable=False
        )
