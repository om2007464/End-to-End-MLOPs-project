...
def upgrade():
    ...
    if dialect_name == "sqlite":
        ...
        with op.batch_alter_table(
            ...
            batch_op.alter_column(
                "dag_id", existing_type=string_id_col_type, nullable=False
            )
            batch_op.alter_column(
                "run_id", existing_type=string_id_col_type, nullable=False
            )
            batch_op.alter_column(
                "execution_date", existing_type=dt_type, nullable=False
            )
    elif dialect_name == "mysql":
        with op.batch_alter_table("dag_run") as batch_op:
            batch_op.alter_column(
                "dag_id",
                existing_type=sa.String(length=ID_LEN),
                type_=string_id_col_type,
                nullable=False,
            )
            batch_op.alter_column(
                "run_id",
    ...
    op.add_column(
        "task_instance", sa.Column("run_id", type_=string_id_col_type, nullable=True)
    )
    op.add_column(
        "task_reschedule", sa.Column("run_id", type_=string_id_col_type, nullable=True)
    )
    ...
    update_query = _multi_table_update(
        dialect_name, task_reschedule, task_reschedule.c.run_id
    )
    ...
    with op.batch_alter_table("task_reschedule", schema=None) as batch_op:
        batch_op.alter_column(
            "run_id",
            existing_type=string_id_col_type,
    ...
    if dialect_name == "postgresql":
        ...
        with op.batch_alter_table("task_instance", schema=None) as batch_op:
            ...
            batch_op.alter_column(
                "max_tries", existing_type=sa.Integer(), server_default="-1"
            )
            batch_op.alter_column(
                "pool_slots",
        ...
        update_query = _multi_table_update(
            dialect_name, task_instance, task_instance.c.run_id
        )
        op.execute(update_query)
    ...
    with op.batch_alter_table("task_instance", schema=None) as batch_op:
        ...
        batch_op.create_primary_key(
            "task_instance_pkey", ["dag_id", "task_id", "run_id"]
        )
...
def downgrade():
    ...
    op.add_column(
        "task_reschedule", sa.Column("execution_date", dt_type, nullable=True)
    )

    update_query = _multi_table_update(
        dialect_name, task_instance, task_instance.c.execution_date
    )
    op.execute(update_query)

    update_query = _multi_table_update(
        dialect_name, task_reschedule, task_reschedule.c.execution_date
    )
    op.execute(update_query)
    ...
    with op.batch_alter_table("task_instance", schema=None) as batch_op:
        ...
        batch_op.create_primary_key(
            "task_instance_pkey", ["dag_id", "task_id", "execution_date"]
        )
    ...
    if dialect_name == "mssql":
        with op.batch_alter_table("dag_run", schema=None) as batch_op:
            batch_op.drop_constraint(
                "dag_run_dag_id_execution_date_key", type_="unique"
            )
            ...
            batch_op.alter_column(
                "dag_id", existing_type=string_id_col_type, nullable=True
            )
            batch_op.alter_column(
                "execution_date", existing_type=dt_type, nullable=True
            )
            batch_op.alter_column(
                "run_id", existing_type=string_id_col_type, nullable=True
            )
        ...
        with op.batch_alter_table("dag_run", schema=None) as batch_op:
            batch_op.drop_index("dag_id_state")
            batch_op.alter_column(
                "run_id", existing_type=sa.VARCHAR(length=250), nullable=True
            )
            batch_op.alter_column(
                "execution_date", existing_type=dt_type, nullable=True
            )
            batch_op.alter_column(
                "dag_id", existing_type=sa.VARCHAR(length=250), nullable=True
            )
            batch_op.create_index("dag_id_state", ["dag_id", "state"], unique=False)
