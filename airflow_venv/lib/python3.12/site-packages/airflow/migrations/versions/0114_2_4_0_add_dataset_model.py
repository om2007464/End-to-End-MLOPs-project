...
def _create_dataset_event_table():
    ...
    op.create_index(
        "idx_dataset_id_timestamp", "dataset_event", ["dataset_id", "timestamp"]
    )
...
def _create_dataset_event_dag_run_table():
    op.create_table(
        ...
        sa.PrimaryKeyConstraint(
            "dag_run_id", "event_id", name=op.f("dagrun_dataset_events_pkey")
        ),
    )
    with op.batch_alter_table("dagrun_dataset_event") as batch_op:
        batch_op.create_index(
            "idx_dagrun_dataset_events_dag_run_id", ["dag_run_id"], unique=False
        )
        batch_op.create_index(
            "idx_dagrun_dataset_events_event_id", ["event_id"], unique=False
        )
