...
ARG_EXCLUDE_SUBDAGS = Arg(
    ("-x", "--exclude-subdags"), help="Exclude subdags", action="store_true"
)
...
ARG_READ_FROM_DB = Arg(
    ("--read-from-db",),
    help="Read dag from DB instead of dag file",
    action="store_true",
)
...
PROVIDERS_COMMANDS = (
    ...
    ActionCommand(
        ...
        func=lazy_load_command(
            "airflow.cli.commands.provider_command.auth_backend_list"
        ),
        args=(ARG_OUTPUT, ARG_VERBOSE),
    ),
    ActionCommand(
