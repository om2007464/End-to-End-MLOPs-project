...
def default_values_yaml_from_type_snap(
    ...
    run_config_dict = _cleanup_run_config_dict(
        default_values_from_type_snap(type_snap, snapshot)
    )
...
def default_values_from_type_snap(
    type_snap: ConfigTypeSnap, snapshot: ConfigSchemaSnapshot
) -> Any:
    ...
    for field_name in type_snap.field_names:
        ...
        # to assemble the default values for the child fields
            ...
            defaults_by_field[field_name] = default_values_from_type_snap(
                field_snap, snapshot
            )
