...
def build_node_invocation_snap(
    graph_def: GraphDefinition, node: Node
) -> "NodeInvocationSnap":
...
@whitelist_for_serdes(
    storage_field_names={"node_invocation_snaps": "solid_invocation_snaps"}
)
...
class InputHandle(
    NamedTuple(
        "_InputHandle",
        [("node_def_name", str), ("node_name", str), ("input_name", str)],
    )
):
...
class DependencyStructureIndex:
    ...
    def _build_index(
        ...
        output_to_upstream_index: DefaultDict[
            str, Mapping[str, List[InputHandle]]
    ...
    def get_upstream_outputs(
        self, node_name: str, input_name: str
    ...
    def get_downstream_inputs(
        self, node_name: str, output_name: str
    ) -> Sequence[InputHandle]:
        check.str_param(node_name, "node_name")
...
class OutputHandleSnap(
    NamedTuple("_OutputHandleSnap", [("node_name", str), ("output_name", str)])
):
...
class InputDependencySnap(
    ...
    def __new__(
        ...
        return super(InputDependencySnap, cls).__new__(
            ...
            is_dynamic_collect=check.bool_param(
                is_dynamic_collect, "is_dynamic_collect"
            ),
        )
