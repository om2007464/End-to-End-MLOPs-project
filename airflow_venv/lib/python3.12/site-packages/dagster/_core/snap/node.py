...
class OutputMappingSnap(
    ...
    def __new__(
        ...
        return super(OutputMappingSnap, cls).__new__(
            ...
            mapped_output_name=check.str_param(
                mapped_output_name, "mapped_output_name"
            ),
            external_output_name=check.str_param(
...
class GraphDefSnap(
    ...
    def __new__(
        ...
        return super(GraphDefSnap, cls).__new__(
            ...
            name=check.str_param(name, "name"),
            input_def_snaps=check.sequence_param(
                input_def_snaps, "input_def_snaps", InputDefSnap
            ),
...
def _get_input_snap(
    node_def: Union[GraphDefSnap, OpDefSnap], name: str
) -> InputDefSnap:
