...
class DataVersionCache:
    def __init__(self, context: "StepExecutionContext"):
        ...
        self.input_asset_version_info: Dict[
            AssetKey, Optional["InputAssetVersionInfo"]
        ] = {}
    ...
    def _fetch_input_asset_version_info(self, asset_keys: Sequence[AssetKey]) -> None:
        ...
        for key in asset_keys:
            ...
            if event is None:
                ...
                if input_name and self._context.has_asset_partitions_for_input(
                    input_name
                ):
                    ...
                    if (
                        ...
                        data_version = extract_data_version_from_entry(
    ...
    def _fetch_asset_records(
        ...
        batch_size = int(
            os.getenv("GET_ASSET_RECORDS_FOR_DATA_VERSION_BATCH_SIZE", "100")
        )
    ...
    def _get_input_asset_event(
        ...
        if (
            ...
            event = next(
                iter(self._context.instance.fetch_observations(key, limit=1).records),
                None,
            )
