...
class AssetExecutionContext:
    def __init__(self, op_execution_context: OpExecutionContext) -> None:
        ...
        self._step_execution_context = (
            self._op_execution_context._step_execution_context
        )  # noqa: SLF001
    ...
    def get() -> "AssetExecutionContext":
        ...
        if ctx is None:
            raise DagsterInvariantViolationError(
                "No current AssetExecutionContext in scope."
            )
    ...
    def asset_partition_key_for_output(self, output_name: str = "result") -> str:
        return self.op_execution_context.asset_partition_key_for_output(
    ...
    def asset_partitions_def_for_output(
        ...
        return self.op_execution_context.asset_partitions_def_for_output(
            output_name=output_name
        )
    ...
    def asset_partition_keys_for_output(
        ...
        return self.op_execution_context.asset_partition_keys_for_output(
            output_name=output_name
        )
    ...
    def asset_partitions_def_for_input(self, input_name: str) -> PartitionsDefinition:
        return self.op_execution_context.asset_partitions_def_for_input(
    ...
    def asset_partition_keys_for_input(self, input_name: str) -> Sequence[str]:
        return self.op_execution_context.asset_partition_keys_for_input(
            input_name=input_name
        )
    ...
    def set_requires_typed_event_stream(
        ...
        self.op_execution_context.set_requires_typed_event_stream(
