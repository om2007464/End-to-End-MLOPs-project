...
class LegacyRunStorage(RunStorage, ConfigurableClass):
    def __init__(
        self, storage: DagsterStorage, inst_data: Optional[ConfigurableClassData] = None
    ):
    ...
    def get_runs(
        ...
        return self._storage.run_storage.get_runs(
            filters, cursor, limit, bucket_by, ascending
        )
    ...
    def get_run_group(
        self, run_id: str
    ) -> Optional[Tuple[str, Iterable["DagsterRun"]]]:
    ...
    def has_execution_plan_snapshot(self, execution_plan_snapshot_id: str) -> bool:
        return self._storage.run_storage.has_execution_plan_snapshot(
    ...
    def get_execution_plan_snapshot(
        ...
        return self._storage.run_storage.get_execution_plan_snapshot(
            execution_plan_snapshot_id
        )
    ...
    def replace_job_origin(
        self, run: "DagsterRun", job_origin: "RemoteJobOrigin"
    ) -> None:
...
class LegacyEventLogStorage(EventLogStorage, ConfigurableClass):
    ...
    def fetch_observations(
        ...
        return self._storage.event_log_storage.fetch_observations(
            filters, limit, cursor, ascending
        )
    ...
    def get_asset_check_summary_records(
        ...
        return self._storage.event_log_storage.get_asset_check_summary_records(
            asset_check_keys
        )
    ...
    def get_latest_materialization_events(
        ...
        return self._storage.event_log_storage.get_latest_materialization_events(
            asset_keys
        )
    ...
    def set_concurrency_slots(self, concurrency_key: str, num: int) -> None:
        return self._storage.event_log_storage.set_concurrency_slots(
            concurrency_key, num
        )
    ...
    def free_concurrency_slot_for_step(self, run_id: str, step_key: str) -> None:
        return self._storage.event_log_storage.free_concurrency_slot_for_step(
            run_id, step_key
        )
...
class LegacyScheduleStorage(ScheduleStorage, ConfigurableClass):
    ...
    def get_instigator_state(
        ...
        return self._storage.schedule_storage.get_instigator_state(
    ...
    def delete_instigator_state(self, origin_id: str, selector_id: str) -> None:
        return self._storage.schedule_storage.delete_instigator_state(
            origin_id, selector_id
        )
    ...
    def get_batch_ticks(
        ...
        return self._storage.schedule_storage.get_batch_ticks(
            selector_ids, limit, statuses
        )
