...
class ChildProcessDoneEvent(
    NamedTuple("ChildProcessDoneEvent", [("pid", int)]), ChildProcessEvent
):
    pass
...
class ChildProcessSystemErrorEvent(
    NamedTuple(
        ...
        [("pid", int), ("error_info", SerializableErrorInfo)],
    ),
    ChildProcessEvent,
):
    pass
    ...
    try:
        ...
        if not completed_properly:
            ...
            raise ChildProcessCrashException(
                pid=process.pid, exit_code=process.exitcode
            )
