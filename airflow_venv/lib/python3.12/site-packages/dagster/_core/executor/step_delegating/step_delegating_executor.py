...
class StepDelegatingExecutor(Executor):
    ...
    def __init__(
        ...
        self._sleep_seconds = cast(
            ...
            check.opt_float_param(
                sleep_seconds, "sleep_seconds", default=_default_sleep_seconds()
            ),
        )
        ...
        self._pop_events_limit = int(
            os.getenv("DAGSTER_EXECUTOR_POP_EVENTS_LIMIT", "1000")
        )
    ...
    def _pop_events(
        ...
        if not pop_events_offset:
            ...
            self._event_cursor = EventLogCursor.from_storage_id(
                desired_next_storage_id
            ).to_string()
            ...
            current_cursor_storage_id = (
                EventLogCursor.parse(self._event_cursor).storage_id()
                ...
                try:
                    ...
                    while not active_execution.is_complete:
                        ...
                        if self._max_concurrent is not None:
                            ...
                            check.invariant(
                                max_steps_to_run >= 0,
                                "More steps are active than max_concurrent",
                            )
                        else:
