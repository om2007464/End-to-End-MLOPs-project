...
class MultiprocessExecutorChildProcessCommand(ChildProcessCommand):
    ...
    def execute(self) -> Iterator[DagsterEvent]:
        ...
        with DagsterInstance.from_ref(self.instance_ref) as instance:
            ...
            try:
                log_manager = create_context_free_log_manager(
                    instance, self.dagster_run
                )
...
class MultiprocessExecutor(Executor):
    ...
    def execute(
        ...
        with ExitStack() as stack:
            ...
            try:
                while (
                    not stopping and not active_execution.is_complete
                ) or active_iters:
                    ...
                    while not stopping:
                        ...
                        yield from active_execution.concurrency_event_iterator(
                            plan_context
                        )
