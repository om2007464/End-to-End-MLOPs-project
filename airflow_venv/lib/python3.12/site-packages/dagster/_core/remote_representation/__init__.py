...
from dagster._core.remote_representation.historical import (
    HistoricalJob as HistoricalJob,
)
...
from dagster._core.remote_representation.represented import (
    RepresentedJob as RepresentedJob,
)
