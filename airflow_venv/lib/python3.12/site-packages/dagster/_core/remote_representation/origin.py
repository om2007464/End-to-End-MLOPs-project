...
def _assign_loadable_target_origin_name(
...
class InProcessCodeLocationOrigin(
    ...
    def __new__(
        ...
        return super(InProcessCodeLocationOrigin, cls).__new__(
            ...
            container_context=check.opt_dict_param(
...
@whitelist_for_serdes(
    ...
    skip_when_empty_fields={"use_ssl"},
)
    ...
    def reload_location(self, instance: "DagsterInstance") -> "GrpcServerCodeLocation":
        ...
        try:
            self.create_client().reload_code(
                timeout=instance.code_server_reload_timeout
            )
...
class RemotePartitionSetOrigin(
    ...
    def __new__(
        cls, repository_origin: RemoteRepositoryOrigin, partition_set_name: str
    ):
