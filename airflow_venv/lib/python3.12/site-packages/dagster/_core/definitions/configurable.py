...
T_Configurable = TypeVar(
    "T_Configurable",
    bound=Union["AnonymousConfigurableDefinition", "NamedConfigurableDefinition"],
)
...
def _wrap_user_fn_if_pythonic_config(
    ...
    check.invariant(
        len(config_fn_params) == 1,
        "@configured function should have exactly one parameter",
    )
    ...
    return FunctionAndConfigSchema(
