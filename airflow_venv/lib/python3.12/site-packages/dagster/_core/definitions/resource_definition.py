...
class ResourceDefinition(AnonymousConfigurableDefinition, IHasInternalInit):
    ...
    def none_resource(description: Optional[str] = None) -> "ResourceDefinition":
        ...
        return ResourceDefinition.hardcoded_resource(
            value=None, description=description
        )

    @public
    @staticmethod
    def hardcoded_resource(
        value: Any, description: Optional[str] = None
    ) -> "ResourceDefinition":
        ...
        if has_at_least_one_parameter(self.resource_fn):
            ...
            if args:
                check.opt_inst_param(
                    args[0], context_param_name, UnboundInitResourceContext
                )
                ...
                return resource_invocation_result(
                    self,
                    cast(
                        Optional[UnboundInitResourceContext], kwargs[context_param_name]
                    ),
                )
