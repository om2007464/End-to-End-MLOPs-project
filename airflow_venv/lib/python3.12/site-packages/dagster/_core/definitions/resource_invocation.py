...
def resource_invocation_result(
    ...
    init_context: Optional["UnboundInitResourceContext"],
) -> Any:
...
def _check_invocation_requirements(
    ...
    if (
        context_provided
        and resource_def.required_resource_keys
...
def resolve_bound_config(config: Any, configurable_def: ConfigurableDefinition) -> Any:
    ...
    config_evr = process_config(
        outer_config_shape, {"config": config} if config else {}
    )
    ...
    mapped_config_evr = configurable_def.apply_config_mapping(
