...
class MetadataValue(ABC, Generic[T_Packable]):
    ...
    def timestamp(value: Union["float", datetime]) -> "TimestampMetadataValue":
        ...
        if isinstance(value, float):
            ...
            check.failed(
                f"Expected either a float or a datetime, but received a {type(value)}"
            )
    ...
    @staticmethod
    def code_location_reconstruction(
        data: str,
...
class TimestampMetadataValue(
    ...
    def __new__(cls, value: float):
        return super(TimestampMetadataValue, cls).__new__(
            cls, check.float_param(value, "value")
        )
...
class TableColumnLineageMetadataValue(
    NamedTuple(
        "_TableColumnLineageMetadataValue",
        [("column_lineage", PublicAttr[TableColumnLineage])],
    ),
