...
class DefinitionsLoadContext:
    ...
    def get(cls) -> "DefinitionsLoadContext":
        ...
        """
        return DefinitionsLoadContext._instance or cls(
    ...
    def cacheable_asset_data(
        ...
        return (
            self._repository_load_data.cacheable_asset_data
...
class StateBackedDefinitionsLoader(ABC, Generic[TState]):
    ...
    def get_or_fetch_state(self) -> TState:
        ...
        state = (
            cast(
                TState,
                deserialize_value(context.reconstruction_metadata[self.defs_key]),
            )
            if (
        ...
        context.add_to_pending_reconstruction_metadata(
