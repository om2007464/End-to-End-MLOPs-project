...
class ScheduleType(Enum):
    ...
    def __gt__(self, other: "ScheduleType") -> bool:
        check.inst_param(
            ...
            "other",
            ScheduleType,
            "Cannot compare ScheduleType with non-ScheduleType",
        )
            ...
            (
                ...
                PublicAttr[
                    Optional[
                        Callable[
                            [Optional[datetime]],
                            Union[Sequence[Partition], Sequence[str]],
                        ]
                    ]
                ],
            ),
...
class PartitionedConfig(Generic[T_PartitionsDefinition]):
    ...
    def __init__(
        ...
        run_config_for_partition_fn: Optional[
            Callable[[Partition], Mapping[str, Any]]
        ] = None,
        decorated_fn: Optional[
            Callable[..., Union[RunConfig, Mapping[str, Any]]]
        ] = None,
        tags_for_partition_fn: Optional[
            Callable[[Partition[Any]], Mapping[str, str]]
        ] = None,
        ...
        self._partitions = check.inst_param(
    ...
    def from_flexible_config(
        cls,
        config: Optional[
            Union[ConfigMapping, Mapping[str, object], "PartitionedConfig"]
        ],
        ...
        if isinstance(config, PartitionedConfig):
            ...
            return cls(
                ...
                run_config_for_partition_key_fn=lambda _: cast(
                    Mapping, hardcoded_config
                ),
            )
...
class DefaultPartitionsSubset(
    ...
    def can_deserialize(
        ...
        return isinstance(data, list) or (
            data.get("subset") is not None
            and data.get("version") == cls.SERIALIZATION_VERSION
        )

    def __eq__(self, other: object) -> bool:
        return (
            isinstance(other, DefaultPartitionsSubset) and self.subset == other.subset
        )
...
class AllPartitionsSubset(
    ...
    def get_partition_key_ranges(
        ...
        check.param_invariant(
            dynamic_partitions_store is None, "dynamic_partitions_store"
        )
    ...
    def __eq__(self, other: object) -> bool:
        return (
            isinstance(other, AllPartitionsSubset)
            and other.partitions_def == self.partitions_def
        )
