...
def get_asset_sensor_param_names(fn: Callable[..., Any]) -> AssetSensorParamNames:
    ...
    context_param_name = (
        non_resource_params[0] if len(non_resource_params) > 0 else None
    )
    event_log_entry_param_name = (
        non_resource_params[1] if len(non_resource_params) > 1 else None
    )

    return AssetSensorParamNames(
        context_param_name=context_param_name,
        event_log_entry_param_name=event_log_entry_param_name,
    )
