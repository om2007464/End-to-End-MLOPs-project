...
def asset_check(
    *,
    ...
    def inner(fn: AssetCheckFunction) -> AssetChecksDefinition:
        ...
        additional_dep_keys = set(
            [dep.asset_key for dep in make_asset_deps(additional_deps) or []]
        )
...
def multi_asset_check(
    *,
    ...
    def inner(fn: MultiAssetCheckFunction) -> AssetChecksDefinition:
        ...
        outs = {
            spec.get_python_identifier(): Out(None, is_required=not can_subset)
            for spec in specs
        }
        ...
        return AssetChecksDefinition.create(
            ...
            check_specs_by_output_name={
                spec.get_python_identifier(): spec for spec in specs
            },
