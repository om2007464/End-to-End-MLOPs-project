...
class EntitySubset(Generic[T_EntityKey]):
    ...
    def __init__(
        ...
        self._key = key
        self._value = check.inst_param(
            value, "value", _ValidatedEntitySubsetValue
        ).inner
    ...
    def _oper(self, other: Self, oper: Callable[..., Any]) -> Self:
        ...
        return self.__class__(
            ...
            key=self._key,
            value=_ValidatedEntitySubsetValue(value),
        )
    ...
    def compute_intersection_with_partition_keys(
        ...
        partition_subset = (
            self._asset_graph_view.get_asset_subset_from_asset_partitions(
    ...
    def compute_mapped_subset(
        ...
        return self._asset_graph_view.compute_mapped_subset(
            to_key, self, direction=direction
        )
