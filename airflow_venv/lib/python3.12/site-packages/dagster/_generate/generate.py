...
def generate_project(
    ...
    for root, dirs, files in os.walk(project_template_path):
        ...
        for dirname in dirs:
            ...
            src_relative_dir_path: str = os.path.relpath(
                src_dir_path, project_template_path
            )
        ...
        for filename in files:
            ...
            src_relative_file_path: str = os.path.relpath(
                src_file_path, project_template_path
            )
            ...
            with open(dst_file_path, "w", encoding="utf8") as f:
                ...
                template_name: str = src_relative_file_path.replace(
                    os.sep, posixpath.sep
                )
                template: jinja2.environment.Template = env.get_template(
                    name=template_name
                )
                f.write(
                    template.render(
