...
def cpu_cfs_quota_us_path() -> str:
    ...
    """
    return os.getenv(
        "DAGSTER_CPU_CFS_QUOTA_US_PATH", "/sys/fs/cgroup/cpu/cpu.cfs_quota_us"
    )
...
def cpu_cfs_period_us_path() -> str:
    ...
    """
    return os.getenv(
        "DAGSTER_CPU_CFS_PERIOD_US_PATH", "/sys/fs/cgroup/cpu/cpu.cfs_period_us"
    )
...
def memory_usage_path_cgroup_v1() -> str:
    ...
    """
    return os.getenv(
        "DAGSTER_MEMORY_USAGE_PATH_V1", "/sys/fs/cgroup/memory/memory.usage_in_bytes"
    )
...
def memory_limit_path_cgroup_v1() -> str:
    ...
    """
    return os.getenv(
        "DAGSTER_MEMORY_LIMIT_PATH_V1", "/sys/fs/cgroup/memory/memory.limit_in_bytes"
    )
...
def _retrieve_cgroup_version(
    logger: Optional[logging.Logger],
) -> Optional[CGroupVersion]:
    try:
...
def _retrieve_containerized_cpu_usage_v1(
    logger: Optional[logging.Logger],
) -> Optional[float]:
    try:
...
def _retrieve_containerized_cpu_usage_v2(
    logger: Optional[logging.Logger],
) -> Optional[float]:
    try:
...
def _retrieve_containerized_num_allocated_cores(
    logger: Optional[logging.Logger],
) -> Optional[int]:
...
def _retrieve_containerized_memory_usage_v1(
    logger: Optional[logging.Logger],
) -> Optional[int]:
    try:
...
def _retrieve_containerized_memory_usage_v2(
    logger: Optional[logging.Logger],
) -> Optional[int]:
    try:
...
def _retrieve_containerized_memory_limit_v1(
    logger: Optional[logging.Logger],
) -> Optional[int]:
    try:
...
def _retrieve_containerized_memory_limit_v2(
    logger: Optional[logging.Logger],
) -> Optional[int]:
    try:
