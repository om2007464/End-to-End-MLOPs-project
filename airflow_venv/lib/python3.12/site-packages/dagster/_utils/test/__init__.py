...
def build_job_with_input_stubs(
    ...
    for node_name, input_dict in inputs.items():
        ...
        for input_name, input_value in input_dict.items():
            ...
            deps[_dep_key_of(node)][input_name] = DependencyDefinition(
                stub_node_def.name
            )
...
def wrap_op_in_graph_and_execute(
    ...
    return (
        wrap_op_in_graph(
            op_def,
            tags,
            do_input_mapping=do_input_mapping,
            do_output_mapping=do_output_mapping,
        )
...
class ConcurrencyEnabledSqliteTestEventLogStorage(
    SqliteEventLogStorage, ConfigurableClass
):
    ...
    def config_type(cls) -> UserConfigSchema:
        return {
            ...
            "sleep_interval": Field(float, is_required=False),
        }
    ...
    def from_config_value(
        ...
        return ConcurrencyEnabledSqliteTestEventLogStorage(
            inst_data=inst_data, **config_value
        )
    ...
    def check_concurrency_claim(
        ...
        claim_status = super().check_concurrency_claim(
