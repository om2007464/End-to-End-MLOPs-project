...
from dagster._core.execution.job_execution_result import (
    JobExecutionResult as JobExecutionResult,
)
...
from dagster._core.pipes.subprocess import (
    PipesSubprocessClient as PipesSubprocessClient,
)
...
def __getattr__(name: str) -> TypingAny:
    if name in _DEPRECATED:
        ...
        deprecation_warning(
            name, breaking_version, additional_warn_text, stacklevel=stacklevel
        )
        return value
