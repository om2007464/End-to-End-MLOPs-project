...
class DagsterGrpcClient:
    ...
    async def _gen_query(
        ...
        **kwargs,
        ...
        try:
            return await self._gen_response(
                method, request=request_type(**kwargs), timeout=timeout
            )
        except Exception as e:
            self._raise_grpc_exception(
    ...
    def execution_plan_snapshot(
        ...
        res = self._query(
            ...
            serialized_execution_plan_snapshot_args=serialize_value(
                execution_plan_snapshot_args
            ),
        )
    ...
    def external_partition_names(self, partition_names_args: PartitionNamesArgs) -> str:
        check.inst_param(
            partition_names_args, "partition_names_args", PartitionNamesArgs
        )
    ...
    def external_pipeline_subset(
        ...
        res = self._query(
            ...
            serialized_pipeline_subset_snapshot_args=serialize_value(
                pipeline_subset_snapshot_args
            ),
        )
    ...
    def external_repository(
        ...
        res = self._query(
            ...
            serialized_repository_python_origin=serialize_value(
                remote_repository_origin
            ),
    ...
    def external_sensor_execution(
        self, sensor_execution_args: SensorExecutionArgs
    ) -> str:
        check.inst_param(
    ...
    def cancel_execution(self, cancel_execution_request: CancelExecutionRequest) -> str:
        ...
        res = self._query(
            ...
            serialized_cancel_execution_request=serialize_value(
                cancel_execution_request
            ),
        )
    ...
    def can_cancel_execution(
        ...
        res = self._query(
            ...
            timeout=timeout,
            serialized_can_cancel_execution_request=serialize_value(
                can_cancel_execution_request
            ),
        )
