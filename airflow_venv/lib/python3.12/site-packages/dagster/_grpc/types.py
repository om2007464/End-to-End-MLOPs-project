...
class ExecutionPlanSnapshotArgs(
    ...
    def __new__(
        ...
        return super(ExecutionPlanSnapshotArgs, cls).__new__(
            ...
            op_selection=check.opt_sequence_param(
            ...
            instance_ref=check.opt_inst_param(
...
class ExecuteStepArgs(
    ...
    def get_command_args(
        self, skip_serialized_namedtuple: bool = False
    ) -> Sequence[str]:
        ...
        return [
            {
                ...
                "value": self._get_compressed_args(),
            },
        ]
...
class LoadableRepositorySymbol(
    NamedTuple(
        "_LoadableRepositorySymbol", [("repository_name", str), ("attribute", str)]
    )
):
...
class PartitionSetExecutionParamArgs(
    ...
    def __new__(
        ...
        return super(PartitionSetExecutionParamArgs, cls).__new__(
            ...
            partition_names=check.sequence_param(
...
class SensorExecutionArgs(
    ...
    def __new__(
        ...
        normalized_last_tick_completion_time = (
            ...
            if last_tick_completion_time
            else last_completion_time
        )
...
class ShutdownServerResult(
    ...
    def __new__(
        cls, success: bool, serializable_error_info: Optional[SerializableErrorInfo]
    ):
...
class CanCancelExecutionRequest(
    NamedTuple("_CanCancelExecutionRequest", [("run_id", str)])
):
    def __new__(cls, run_id: str):
...
class CanCancelExecutionResult(
    NamedTuple("_CancelExecutionResult", [("can_cancel", bool)])
):
