    ...
    def from_dict(cls, d: Dict[str, any]) -> GetPasswordPermissionLevelsResponse:
        ...
        return cls(
            permission_levels=_repeated_dict(
                d, "permission_levels", PasswordPermissionsDescription
            )
        )
...
class GetPermissionLevelsResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetPermissionLevelsResponse:
        ...
        return cls(
            permission_levels=_repeated_dict(
                d, "permission_levels", PermissionsDescription
            )
        )
...
class Name:
    ...
    def from_dict(cls, d: Dict[str, any]) -> Name:
        ...
        return cls(
            family_name=d.get("familyName", None), given_name=d.get("givenName", None)
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> ObjectPermissions:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", AccessControlResponse
            ),
...
class PermissionAssignments:
    ...
    def from_dict(cls, d: Dict[str, any]) -> PermissionAssignments:
        ...
        return cls(
            permission_assignments=_repeated_dict(
                d, "permission_assignments", PermissionAssignment
            )
        )
...
class PermissionsRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> PermissionsRequest:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", AccessControlRequest
            ),
...
class AccountAccessControlAPI:
    ...
    def update_rule_set(
        self, name: str, rule_set: RuleSetUpdateRequest
    ) -> RuleSetResponse:
        """Update a rule set.
...
class GroupsAPI:
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.0/preview/scim/v2/Groups", body=body, headers=headers
        )
        return Group.from_dict(res)
    ...
    def get(self, id: str) -> Group:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/preview/scim/v2/Groups/{id}", headers=headers
        )
        return Group.from_dict(res)
    ...
    def patch(
        ...
        *,
        ...
        self._api.do(
            "PATCH", f"/api/2.0/preview/scim/v2/Groups/{id}", body=body, headers=headers
        )
    ...
    def update(
        ...
        *,
        ...
        self._api.do(
            "PUT", f"/api/2.0/preview/scim/v2/Groups/{id}", body=body, headers=headers
        )
...
class PermissionMigrationAPI:
    ...
    def migrate_permissions(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.0/permissionmigration", body=body, headers=headers
        )
...
class UsersAPI:
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.0/preview/scim/v2/Users", body=body, headers=headers
        )
        return User.from_dict(res)
    ...
    def get_permissions(self) -> PasswordPermissions:
        ...
        res = self._api.do(
            "GET", "/api/2.0/permissions/authorization/passwords", headers=headers
        )
    ...
    def patch(
        ...
        *,
        ...
        self._api.do(
            "PATCH", f"/api/2.0/preview/scim/v2/Users/{id}", body=body, headers=headers
        )
    ...
    def update(
        ...
        *,
        ...
        self._api.do(
            "PUT", f"/api/2.0/preview/scim/v2/Users/{id}", body=body, headers=headers
        )
