...
class AzureKeyVaultSecretScopeMetadata:
    ...
    def from_dict(cls, d: Dict[str, any]) -> AzureKeyVaultSecretScopeMetadata:
        ...
        return cls(
            dns_name=d.get("dns_name", None), resource_id=d.get("resource_id", None)
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetRepoPermissionLevelsResponse:
        ...
        return cls(
            permission_levels=_repeated_dict(
                d, "permission_levels", RepoPermissionsDescription
            )
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> RepoPermissions:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", RepoAccessControlResponse
            ),
            object_id=d.get("object_id", None),
...
class RepoPermissionsRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> RepoPermissionsRequest:
        ...
        return cls(
            access_control_list=_repeated_dict(
                d, "access_control_list", RepoAccessControlRequest
            ),
...
class SecretScope:
    ...
    def from_dict(cls, d: Dict[str, any]) -> SecretScope:
        ...
        return cls(
            ...
            keyvault_metadata=_from_dict(
                d, "keyvault_metadata", AzureKeyVaultSecretScopeMetadata
            ),
    ...
    def from_dict(cls, d: Dict[str, any]) -> WorkspaceObjectAccessControlRequest:
        ...
        return cls(
            ...
            permission_level=_enum(
                d, "permission_level", WorkspaceObjectPermissionLevel
            ),
            service_principal_name=d.get("service_principal_name", None),
            user_name=d.get("user_name", None),
        )
    ...
    def from_dict(cls, d: Dict[str, any]) -> WorkspaceObjectAccessControlResponse:
        ...
        return cls(
            all_permissions=_repeated_dict(
                d, "all_permissions", WorkspaceObjectPermission
            ),
            display_name=d.get("display_name", None),
            group_name=d.get("group_name", None),
            service_principal_name=d.get("service_principal_name", None),
...
class GitCredentialsAPI:
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.0/git-credentials", body=body, headers=headers
        )
    ...
    def delete(self, credential_id: int):
        ...
        self._api.do(
            "DELETE", f"/api/2.0/git-credentials/{credential_id}", headers=headers
        )
    ...
    def get(self, credential_id: int) -> GetCredentialsResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/git-credentials/{credential_id}", headers=headers
        )
...
class ReposAPI:
    ...
    def get_permissions(self, repo_id: str) -> RepoPermissions:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/permissions/repos/{repo_id}", headers=headers
        )
...
class SecretsAPI:
    ...
    def create_scope(
        ...
        *,
        ...
        self._api.do(
            "POST", "/api/2.0/secrets/scopes/create", body=body, headers=headers
        )
    ...
    def delete_scope(self, scope: str):
        ...
        self._api.do(
            "POST", "/api/2.0/secrets/scopes/delete", body=body, headers=headers
        )
    ...
    def get_acl(self, scope: str, principal: str) -> AclItem:
        ...
        res = self._api.do(
            "GET", "/api/2.0/secrets/acls/get", query=query, headers=headers
        )
    ...
    def list_acls(self, scope: str) -> Iterator[AclItem]:
        ...
        json = self._api.do(
            "GET", "/api/2.0/secrets/acls/list", query=query, headers=headers
        )
    ...
    def list_secrets(self, scope: str) -> Iterator[SecretMetadata]:
        ...
        json = self._api.do(
            "GET", "/api/2.0/secrets/list", query=query, headers=headers
        )
...
class WorkspaceAPI:
    ...
    def export(
        self, path: str, *, format: Optional[ExportFormat] = None
    ) -> ExportResponse:
        ...
        res = self._api.do(
            "GET", "/api/2.0/workspace/export", query=query, headers=headers
        )
    ...
    def get_status(self, path: str) -> ObjectInfo:
        ...
        res = self._api.do(
            "GET", "/api/2.0/workspace/get-status", query=query, headers=headers
        )
    ...
    def list(
        ...
        json = self._api.do(
            "GET", "/api/2.0/workspace/list", query=query, headers=headers
        )
