...
class AddExchangeForListingRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> AddExchangeForListingRequest:
        ...
        return cls(
            exchange_id=d.get("exchange_id", None), listing_id=d.get("listing_id", None)
        )
...
class AddExchangeForListingResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> AddExchangeForListingResponse:
        ...
        return cls(
            exchange_for_listing=_from_dict(d, "exchange_for_listing", ExchangeListing)
        )
...
class CreateFileRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CreateFileRequest:
        ...
        return cls(
            ...
            marketplace_file_type=_enum(
                d, "marketplace_file_type", MarketplaceFileType
            ),
...
class CreateInstallationRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CreateInstallationRequest:
        ...
        return cls(
            accepted_consumer_terms=_from_dict(
                d, "accepted_consumer_terms", ConsumerTerms
            ),
...
class GetListingContentMetadataResponse:
    ...
    def as_dict(self) -> dict:
        ...
        if self.shared_data_objects:
            body["shared_data_objects"] = [
                v.as_dict() for v in self.shared_data_objects
            ]
        return body
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetListingContentMetadataResponse:
        ...
        return cls(
            ...
            shared_data_objects=_repeated_dict(
                d, "shared_data_objects", SharedDataObject
            ),
        )
...
class GetPersonalizationRequestResponse:
    ...
    def as_dict(self) -> dict:
        ...
        if self.personalization_requests:
            body["personalization_requests"] = [
                v.as_dict() for v in self.personalization_requests
            ]
        return body
...
class ListingDetail:
    ...
    def from_dict(cls, d: Dict[str, any]) -> ListingDetail:
        ...
        return cls(
            ...
            collection_granularity=_from_dict(
                d, "collection_granularity", DataRefreshInfo
            ),
...
class RepoInstallation:
    ...
    def from_dict(cls, d: Dict[str, any]) -> RepoInstallation:
        ...
        return cls(
            repo_name=d.get("repo_name", None), repo_path=d.get("repo_path", None)
        )
...
class SharedDataObject:
    ...
    def from_dict(cls, d: Dict[str, any]) -> SharedDataObject:
        ...
        return cls(
            data_object_type=d.get("data_object_type", None), name=d.get("name", None)
        )
...
class UpdateProviderRequest:
    ...
    def from_dict(cls, d: Dict[str, any]) -> UpdateProviderRequest:
        ...
        return cls(
            id=d.get("id", None), provider=_from_dict(d, "provider", ProviderInfo)
        )
...
class ConsumerListingsAPI:
    ...
    def get(self, id: str) -> GetListingResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.1/marketplace-consumer/listings/{id}", headers=headers
        )
...
class ConsumerProvidersAPI:
    ...
    def get(self, id: str) -> GetProviderResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.1/marketplace-consumer/providers/{id}", headers=headers
        )
...
class ProviderExchangeFiltersAPI:
    ...
    def delete(self, id: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.0/marketplace-exchange/filters/{id}", headers=headers
        )
...
class ProviderExchangesAPI:
    ...
    def delete(self, id: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.0/marketplace-exchange/exchanges/{id}", headers=headers
        )
    ...
    def get(self, id: str) -> GetExchangeResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/marketplace-exchange/exchanges/{id}", headers=headers
        )
...
class ProviderFilesAPI:
    ...
    def delete(self, file_id: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.0/marketplace-provider/files/{file_id}", headers=headers
        )
    ...
    def get(self, file_id: str) -> GetFileResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/marketplace-provider/files/{file_id}", headers=headers
        )
...
class ProviderListingsAPI:
    ...
    def delete(self, id: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.0/marketplace-provider/listings/{id}", headers=headers
        )
    ...
    def get(self, id: str) -> GetListingResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/marketplace-provider/listings/{id}", headers=headers
        )
        return GetListingResponse.from_dict(res)
...
class ProviderProvidersAPI:
    ...
    def delete(self, id: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.0/marketplace-provider/providers/{id}", headers=headers
        )
    ...
    def get(self, id: str) -> GetProviderResponse:
        ...
        res = self._api.do(
            "GET", f"/api/2.0/marketplace-provider/providers/{id}", headers=headers
        )
        return GetProviderResponse.from_dict(res)
