...
class AlertConfiguration:
    ...
    def as_dict(self) -> dict:
        ...
        if self.action_configurations:
            body["action_configurations"] = [
                v.as_dict() for v in self.action_configurations
            ]
    ...
    def from_dict(cls, d: Dict[str, any]) -> AlertConfiguration:
        ...
        return cls(
            action_configurations=_repeated_dict(
                d, "action_configurations", ActionConfiguration
            ),
...
class BudgetConfiguration:
    ...
    def as_dict(self) -> dict:
        ...
        if self.alert_configurations:
            body["alert_configurations"] = [
                v.as_dict() for v in self.alert_configurations
            ]
    ...
    def from_dict(cls, d: Dict[str, any]) -> BudgetConfiguration:
        ...
        return cls(
            ...
            alert_configurations=_repeated_dict(
                d, "alert_configurations", AlertConfiguration
            ),
...
class BudgetConfigurationFilter:
    ...
    def from_dict(cls, d: Dict[str, any]) -> BudgetConfigurationFilter:
        ...
        return cls(
            ...
            workspace_id=_from_dict(
                d, "workspace_id", BudgetConfigurationFilterWorkspaceIdClause
            ),
        )
...
class CreateBudgetConfigurationBudget:
    ...
    alert_configurations: Optional[
        List[CreateBudgetConfigurationBudgetAlertConfigurations]
    ] = None
    """Alerts to configure when this budget is in a triggered state. Budgets must have exactly one
    alert configuration."""
...
class CreateBudgetConfigurationBudgetAlertConfigurations:
    action_configurations: Optional[
        List[CreateBudgetConfigurationBudgetActionConfigurations]
    ] = None
    """Configured actions for this alert. These define what happens when an alert enters a triggered
    state."""
...
class BudgetsAPI:
    ...
    def create(
        self, budget: CreateBudgetConfigurationBudget
...
class LogDeliveryAPI:
    ...
    def get(
        self, log_delivery_configuration_id: str
    ) -> WrappedLogDeliveryConfiguration:
    ...
    def list(
        ...
        *,
        ...
        parsed = WrappedLogDeliveryConfigurations.from_dict(
            json
        ).log_delivery_configurations
        return parsed if parsed is not None else []

    def patch_status(
        self, log_delivery_configuration_id: str, status: LogDeliveryConfigStatus
    ):
