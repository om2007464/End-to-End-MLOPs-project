...
class CentralCleanRoomInfo:
    ...
    def as_dict(self) -> dict:
        ...
        if self.clean_room_assets:
            body["clean_room_assets"] = [v.as_dict() for v in self.clean_room_assets]
        ...
        if self.station_cloud is not None:
            body["station_cloud"] = self.station_cloud
        if self.station_region is not None:
            body["station_region"] = self.station_region
        return body
    ...
    def from_dict(cls, d: Dict[str, any]) -> CentralCleanRoomInfo:
        ...
        return cls(
            clean_room_assets=_repeated_dict(
                d, "clean_room_assets", CleanRoomAssetInfo
            ),
...
class CleanRoomAssetInfo:
    ...
    def as_dict(self) -> dict:
        ...
        if self.notebook_info:
            body["notebook_info"] = self.notebook_info.as_dict()
        if self.owner:
            body["owner"] = self.owner.as_dict()
        if self.table_info:
...
class CleanRoomCatalog:
    ...
    def as_dict(self) -> dict:
        ...
        if self.notebook_files:
            body["notebook_files"] = [v.as_dict() for v in self.notebook_files]
        if self.tables:
...
class CleanRoomCatalogUpdate:
    ...
    def as_dict(self) -> dict:
        ...
        if self.catalog_name is not None:
            body["catalog_name"] = self.catalog_name
        if self.updates:
            body["updates"] = self.updates.as_dict()
        return body
...
class CleanRoomInfo:
    ...
    def as_dict(self) -> dict:
        ...
        if self.local_catalogs:
            body["local_catalogs"] = [v.as_dict() for v in self.local_catalogs]
    ...
    def from_dict(cls, d: Dict[str, any]) -> CleanRoomInfo:
        ...
        return cls(
            ...
            remote_detailed_info=_from_dict(
                d, "remote_detailed_info", CentralCleanRoomInfo
            ),
            updated_at=d.get("updated_at", None),
...
class CreateRecipient:
    ...
    def from_dict(cls, d: Dict[str, any]) -> CreateRecipient:
        ...
        return cls(
            ...
            name=d.get("name", None),
            owner=d.get("owner", None),
            properties_kvpairs=_from_dict(
                d, "properties_kvpairs", SecurablePropertiesKvPairs
            ),
...
class GetRecipientSharePermissionsResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> GetRecipientSharePermissionsResponse:
        ...
        return cls(
            ...
            permissions_out=_repeated_dict(
                d, "permissions_out", ShareToPrivilegeAssignment
            ),
        )
...
class ListCleanRoomsResponse:
    ...
    def from_dict(cls, d: Dict[str, any]) -> ListCleanRoomsResponse:
        ...
        return cls(
            clean_rooms=_repeated_dict(d, "clean_rooms", CleanRoomInfo),
            next_page_token=d.get("next_page_token", None),
        )
...
class SharedDataObject:
    ...
    history_data_sharing_status: Optional[
    ...
    **DISABLED**."""
    ...
    def from_dict(cls, d: Dict[str, any]) -> SharedDataObject:
        ...
        return cls(
            ...
            data_object_type=_enum(
                d, "data_object_type", SharedDataObjectDataObjectType
            ),
...
class UpdateCleanRoom:
    ...
    def from_dict(cls, d: Dict[str, any]) -> UpdateCleanRoom:
        ...
        return cls(
            catalog_updates=_repeated_dict(
                d, "catalog_updates", CleanRoomCatalogUpdate
            ),
            comment=d.get("comment", None),
            name=d.get("name", None),
            owner=d.get("owner", None),
...
class CleanRoomsAPI:
    ...
    def create(
        ...
        **CREATE_CLEAN_ROOM** privilege on the metastore.
        ...
        if remote_detailed_info is not None:
            body["remote_detailed_info"] = remote_detailed_info.as_dict()
        headers = {
        ...
        res = self._api.do(
            "POST", "/api/2.1/unity-catalog/clean-rooms", body=body, headers=headers
        )
    ...
    def delete(self, name: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.1/unity-catalog/clean-rooms/{name}", headers=headers
        )

    def get(
        self, name: str, *, include_remote_details: Optional[bool] = None
    ) -> CleanRoomInfo:
        """Get a clean room.
        ...
        if include_remote_details is not None:
            query["include_remote_details"] = include_remote_details
        headers = {
            "Accept": "application/json",
        }
    ...
    def update(
        ...
        *,
        ...
        if catalog_updates is not None:
            body["catalog_updates"] = [v.as_dict() for v in catalog_updates]
        if comment is not None:
            body["comment"] = comment
...
class ProvidersAPI:
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.1/unity-catalog/providers", body=body, headers=headers
        )
    ...
    def delete(self, name: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.1/unity-catalog/providers/{name}", headers=headers
        )
    ...
    def get(self, name: str) -> ProviderInfo:
        ...
        res = self._api.do(
            "GET", f"/api/2.1/unity-catalog/providers/{name}", headers=headers
        )
        return ProviderInfo.from_dict(res)
    ...
    **Databricks-to-Databricks sharing**.
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.1/unity-catalog/recipients", body=body, headers=headers
        )
    ...
    def delete(self, name: str):
        ...
        self._api.do(
            "DELETE", f"/api/2.1/unity-catalog/recipients/{name}", headers=headers
        )
    ...
    def get(self, name: str) -> RecipientInfo:
        ...
        * the caller is the owner of the share recipient, or: * is a metastore admin
        ...
        res = self._api.do(
            "GET", f"/api/2.1/unity-catalog/recipients/{name}", headers=headers
        )
        return RecipientInfo.from_dict(res)
    ...
    def rotate_token(
        self, name: str, existing_token_expire_in_seconds: int
    ) -> RecipientInfo:
        """Rotate a token.
...
class SharesAPI:
    ...
    def create(
        ...
        *,
        ...
        res = self._api.do(
            "POST", "/api/2.1/unity-catalog/shares", body=body, headers=headers
        )
    ...
    def get(
        self, name: str, *, include_shared_data: Optional[bool] = None
    ) -> ShareInfo:
        """Get a share.
