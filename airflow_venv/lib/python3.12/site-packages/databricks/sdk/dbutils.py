...
class _FsUtil:
    ...
    def __init__(
        self, dbfs_ext: dbfs_ext.DbfsExt, proxy_factory: Callable[[str], "_ProxyUtil"]
    ):
        self._dbfs = dbfs_ext
...
class _JobsUtil:
    ...
    class _TaskValuesUtil:
        ...
        def get(
            self, taskKey: str, key: str, default: any = None, debugValue: any = None
        ) -> None:
            """
...
class _ProxyUtil:
    ...
    def __getattr__(
        self, method: str
    ) -> "_ProxyCall | _ProxyUtil | _OverrideProxyUtil":
