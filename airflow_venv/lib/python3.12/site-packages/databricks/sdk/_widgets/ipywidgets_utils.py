...
class IPyWidgetUtil(WidgetUtils):
    ...
    def _register(
        self, name: str, widget: ValueWidget, label: typing.Optional[str] = None
    ):
    ...
    def dropdown(
        ...
        self._register(
            name, widget_selection.Dropdown(value=defaultValue, options=choices), label
        )
    ...
    def combobox(
        ...
        self._register(
            name, widget_string.Combobox(value=defaultValue, options=choices), label
        )
