...
class WorkspaceExt(WorkspaceAPI):
    ...
    def list(
        ...
        **kwargs,
        ...
        while queue:
            ...
            for object_info in parent_list(
                path, notebooks_modified_after=notebooks_modified_after
            ):
        ...
        *,
        ...
        try:
            ...
            if e.error_code == "INVALID_PARAMETER_VALUE":
                msg = (
                    f"Perhaps you forgot to specify the `format=ImportFormat.AUTO`. {e}"
                )
    ...
    def download(self, path: str, *, format: Optional[ExportFormat] = None) -> BinaryIO:
        ...
        response = self._api.do(
            "GET", "/api/2.0/workspace/export", query=query, raw=True
        )
