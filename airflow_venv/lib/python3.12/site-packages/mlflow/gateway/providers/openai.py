...
class OpenAIProvider(BaseProvider):
    ...
    def __init__(self, config: RouteConfig) -> None:
        ...
        if config.model.config is None or not isinstance(
            config.model.config, OpenAIConfig
        ):
    ...
    def _add_model_to_payload_if_necessary(self, payload):
        ...
        if self.openai_config.openai_api_type not in (
            OpenAIAPIType.AZURE,
        ...
        if (
            ...
            messages = [
                *[
                    ...
                    if m["role"] == "tool" or "tool_calls" in m
                ],
            ...
            for _ in range(20):  # loop until we get a response without tool_calls
                ...
                if user_tool_calls:
                    ...
                    if uc_func_calls:
                        resp["choices"][0]["message"]["content"] = join_uc_functions(
                            uc_func_calls
                        )
