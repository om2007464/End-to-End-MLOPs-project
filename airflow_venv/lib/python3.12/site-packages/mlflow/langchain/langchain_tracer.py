...
class MlflowLangchainTracer(BaseCallbackHandler, metaclass=ExceptionSafeAbstractClass):
    ...
    def _assign_span_name(
        self, serialized: Dict[str, Any], default_name="unknown"
    ) -> str:
    ...
    def on_llm_error(
        ...
        **kwargs: Any,
        ...
        self._end_span(
            run_id, llm_span, status=SpanStatus(SpanStatusCode.ERROR, str(error))
        )
    ...
    def on_chain_error(
        ...
        **kwargs: Any,
        ...
        self._end_span(
            run_id, chain_span, status=SpanStatus(SpanStatusCode.ERROR, str(error))
        )
    ...
    def on_tool_error(
        ...
        **kwargs: Any,
        ...
        self._end_span(
            run_id, tool_span, status=SpanStatus(SpanStatusCode.ERROR, str(error))
        )
    ...
    def on_retriever_end(
        ...
        try:
            ...
            documents = [
                MlflowDocument.from_langchain_document(doc) for doc in documents
            ]
    ...
    def on_retriever_error(
        ...
        **kwargs: Any,
        ...
        self._end_span(
            run_id, retriever_span, status=SpanStatus(SpanStatusCode.ERROR, str(error))
        )
    ...
    def on_text(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            _logger.warning(
                "Span not found for text event. Skipping text event logging."
            )
        else:
            span.add_event(
                SpanEvent(
