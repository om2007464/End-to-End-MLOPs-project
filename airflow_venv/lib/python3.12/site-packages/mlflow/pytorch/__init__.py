...
if autolog.__doc__ is not None:
    autolog.__doc__ = autolog.__doc__.replace(
        "MIN_REQ_VERSION", str(MIN_REQ_VERSION)
    ).replace("MAX_REQ_VERSION", str(MAX_REQ_VERSION))


def load_checkpoint(
    model_class, run_id=None, epoch=None, global_step=None, kwargs=None
):
    """
    ...
    with TempDir() as tmp_dir:
        ...
        return model_class.load_from_checkpoint(
            downloaded_checkpoint_filepath, **(kwargs or {})
        )
