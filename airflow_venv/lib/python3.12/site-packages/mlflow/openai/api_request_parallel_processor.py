                ...
                if "Rate limit" in error.get("message", ""):
                    ...
                    if current_time - self.start_time < 600:
                        if current_time - self.last_log_time > 60:
                            _logger.warning(
                                "Retrying for request failed with rate limit."
                            )
...
def num_tokens_consumed_from_request(
    ...
    # more logic needed to support other API calls (e.g., edits, inserts, DALL-E)
        ...
        raise NotImplementedError(
            f'Support for "{request_url}" not implemented in this script'
        )
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        while True:
            ...
            available_token_capacity = min(
                ...
                + int(max_tokens_per_minute * seconds_since_update / 60.0),
            ...
            if next_request:
                _logger.debug(
                    f"Available request capacity: {available_request_capacity}"
                )
