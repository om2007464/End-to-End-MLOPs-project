...
class _PromptlabModel:
    ...
    def __init__(
        self, prompt_template, prompt_parameters, model_parameters, model_route
    ):
    ...
    def predict(self, inputs: pd.DataFrame) -> List[str]:
        ...
        for idx in inputs.index:
            ...
            model_parameters_as_dict = {
                param.key: param.value for param in self.model_parameters
            }
...
def _load_pyfunc(path):
    ...
    with open(parameters_path) as f:
        ...
        prompt_parameters_as_params = [
            ...
            for key, value in parameters["prompt_parameters"].items()
        ]
