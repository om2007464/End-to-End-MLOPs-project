...
class ModelRegistryClient:
    ...
    def search_registered_models(
        ...
        """
        return self.store.search_registered_models(
    ...
    def create_model_version(  # noqa: D417
        ...
        if "local_model_path" in arg_names:
            ...
            mv = self.store.create_model_version(
                name, source, run_id, tags, run_link, description
            )
    ...
    def search_model_versions(
        ...
        """
        return self.store.search_model_versions(
            filter_string, max_results, order_by, page_token
        )
    ...
    def set_model_version_tag(self, name, version, key, value):
        ...
        self.store.set_model_version_tag(
            name, version, ModelVersionTag(key, str(value))
        )
