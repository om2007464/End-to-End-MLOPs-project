...
def _get_registry_uri_from_context():
    ...
    elif (uri := MLFLOW_REGISTRY_URI.get()) or (
        uri := _get_registry_uri_from_spark_session()
    ):
        return uri
    return _registry_uri
...
def _get_databricks_rest_store(store_uri, **_):
    ...
    return DatabricksWorkspaceModelRegistryRestStore(
...
def _get_store_registry():
    ...
    from mlflow.store._unity_catalog.registry.uc_oss_rest_store import (
    ...
    _model_registry_store_registry.register(
        _OSS_UNITY_CATALOG_SCHEME, UnityCatalogOssStore
    )
