...
class IPythonTraceDisplayHandler:
    ...
    def __init__(self):
        ...
        try:
            ...
            get_ipython().events.register(
                "post_run_cell", self._display_traces_post_run
            )
        except Exception:
            ...
            _logger.debug(
                "Failed to register post-run cell display hook", exc_info=True
            )
    ...
    def _display_traces_post_run(self, result):
        ...
        try:
            ...
            traces_to_display = list(self.traces_to_display.values())[
                :MAX_TRACES_TO_DISPLAY
            ]
