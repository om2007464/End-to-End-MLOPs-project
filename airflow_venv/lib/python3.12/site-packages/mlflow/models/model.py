...
SET_MODEL_ERROR = "Model should either be an instance of PyFuncModel, Langchain type, or LlamaIndex index."
            ...
            if model_config := kwargs.get("model_config"):
                ...
                try:
                    mlflow.tracking.fluent.log_params(
                        params_to_log or {}, run_id=run_id
                    )
                except Exception as e:
