...
class DatabricksUCConnection(DatabricksResource):
    ...
    def to_dict(self):
        return (
            {self.type.value: [{"name": self.connection_name}]}
...
class DatabricksServingEndpoint(DatabricksResource):
    ...
    def to_dict(self):
        return (
            {self.type.value: [{"name": self.endpoint_name}]}
...
class DatabricksSQLWarehouse(DatabricksResource):
    ...
    def to_dict(self):
        return (
            {self.type.value: [{"name": self.warehouse_id}]}
...
class DatabricksFunction(DatabricksResource):
    ...
    def to_dict(self):
        return (
            {self.type.value: [{"name": self.function_name}]}
...
class DatabricksGenieSpace(DatabricksResource):
    ...
    def to_dict(self):
        return (
            {self.type.value: [{"name": self.genie_space_id}]}
        ...
        if api_version == "1":
            for target_uri, config in data.items():
                for resource_type, values in config.items():
                    resource_class = _get_resource_class_by_type(
                        target_uri, resource_type
                    )
                    if resource_class:
                        resources.extend(
                            resource_class.from_dict(value) for value in values
                        )
                    else:
