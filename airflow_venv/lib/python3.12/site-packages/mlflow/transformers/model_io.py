...
def save_pipeline_pretrained_weights(path, pipeline, flavor_conf, processor=None):
    ...
    """
    model = (
        get_peft_base_model(pipeline.model)
...
def load_model_and_components_from_local(
    path, flavor_conf, accelerate_conf, device=None
):
    """
    ...
    loaded[FlavorKey.MODEL] = _load_model(
        model_path, flavor_conf, accelerate_conf, device
    )
...
def load_model_and_components_from_huggingface_hub(
    flavor_conf, accelerate_conf, device=None
):
    """
...
def _load_component(flavor_conf, name, local_path=None, repo_id=None):
    ...
    if local_path is not None:
        ...
        return cls.from_pretrained(
            repo, revision=revision, trust_remote_code=trust_remote
        )
...
def _load_model(
    model_name_or_path, flavor_conf, accelerate_conf, device, revision=None
):
    """
