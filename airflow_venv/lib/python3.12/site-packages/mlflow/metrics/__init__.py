...
def recall_score() -> EvaluationMetric:
    ...
    """
    return make_metric(
        eval_fn=_recall_eval_fn, greater_is_better=True, name="recall_score"
    )
...
def f1_score() -> EvaluationMetric:
    ...
    """
    return make_metric(
        eval_fn=_f1_score_eval_fn, greater_is_better=True, name="f1_score"
    )
