...
if Version(google.protobuf.__version__).major >= 5:
    ...
    _builder.BuildTopDescriptorsAndMessages(
        DESCRIPTOR, "unity_catalog_oss_messages_pb2", _globals
    )
    if not _descriptor._USE_C_DESCRIPTORS:
        ...
        _globals[
            "_GENERATETEMPORARYMODELVERSIONCREDENTIAL_RESPONSE"
        ]._serialized_start = 2989
        _globals[
            "_GENERATETEMPORARYMODELVERSIONCREDENTIAL_RESPONSE"
        ]._serialized_end = 3063
    ...
    _LISTREGISTEREDMODELS_RESPONSE = _LISTREGISTEREDMODELS.nested_types_by_name[
        "Response"
    ]
    ...
    _FINALIZEMODELVERSION_RESPONSE = _FINALIZEMODELVERSION.nested_types_by_name[
        "Response"
    ]
    ...
    _GENERATETEMPORARYMODELVERSIONCREDENTIAL = DESCRIPTOR.message_types_by_name[
        "GenerateTemporaryModelVersionCredential"
    ]
    _GENERATETEMPORARYMODELVERSIONCREDENTIAL_RESPONSE = (
        _GENERATETEMPORARYMODELVERSIONCREDENTIAL.nested_types_by_name["Response"]
    )
    RegisteredModelInfo = _reflection.GeneratedProtocolMessageType(
        "RegisteredModelInfo",
        (_message.Message,),
        {
    ...
    ModelVersionInfo = _reflection.GeneratedProtocolMessageType(
        "ModelVersionInfo",
        (_message.Message,),
        {
    ...
    FinalizeModelVersion = _reflection.GeneratedProtocolMessageType(
    ...
    ListModelVersions = _reflection.GeneratedProtocolMessageType(
        "ListModelVersions",
        (_message.Message,),
        {
            "Response": _reflection.GeneratedProtocolMessageType(
    ...
    GenerateTemporaryModelVersionCredential = _reflection.GeneratedProtocolMessageType(
        "GenerateTemporaryModelVersionCredential",
        (_message.Message,),
        {
            "Response": _reflection.GeneratedProtocolMessageType(
