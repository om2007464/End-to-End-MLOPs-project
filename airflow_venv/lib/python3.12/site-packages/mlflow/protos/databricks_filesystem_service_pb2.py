...
if Version(google.protobuf.__version__).major >= 5:
    ...
    _builder.BuildTopDescriptorsAndMessages(
        DESCRIPTOR, "databricks_filesystem_service_pb2", _globals
    )
    if not _descriptor._USE_C_DESCRIPTORS:
        ...
        _globals[
            "_LISTDIRECTORYRESPONSE"
        ]._serialized_options = b"\342?%\n#com.databricks.rpc.DoNotLogContents"
        _globals["_FILESYSTEMSERVICE"].methods_by_name[
            "CreateDownloadUrl"
    ...
    _CREATEDOWNLOADURLREQUEST = DESCRIPTOR.message_types_by_name[
        "CreateDownloadUrlRequest"
    ]
    _CREATEDOWNLOADURLRESPONSE = DESCRIPTOR.message_types_by_name[
        "CreateDownloadUrlResponse"
    ]
    _CREATEUPLOADURLREQUEST = DESCRIPTOR.message_types_by_name["CreateUploadUrlRequest"]
    _CREATEUPLOADURLRESPONSE = DESCRIPTOR.message_types_by_name[
    ...
    CreateDownloadUrlRequest = _reflection.GeneratedProtocolMessageType(
        "CreateDownloadUrlRequest",
        (_message.Message,),
        {
    ...
    CreateDownloadUrlResponse = _reflection.GeneratedProtocolMessageType(
        "CreateDownloadUrlResponse",
        (_message.Message,),
        {
    ...
    CreateUploadUrlRequest = _reflection.GeneratedProtocolMessageType(
    ...
    CreateUploadUrlResponse = _reflection.GeneratedProtocolMessageType(
        "CreateUploadUrlResponse",
        (_message.Message,),
        {
    ...
    DirectoryEntry = _reflection.GeneratedProtocolMessageType(
        "DirectoryEntry",
        (_message.Message,),
        {
    ...
    if _descriptor._USE_C_DESCRIPTORS == False:
        ...
        _CREATEDOWNLOADURLREQUEST._serialized_options = (
            b"\342?3\n1com.databricks.rpc.RPC[CreateDownloadUrlResponse]"
        )
        _CREATEDOWNLOADURLRESPONSE._options = None
        _CREATEDOWNLOADURLRESPONSE._serialized_options = (
            b"\342?%\n#com.databricks.rpc.DoNotLogContents"
        )
        _CREATEUPLOADURLREQUEST._options = None
        _CREATEUPLOADURLREQUEST._serialized_options = (
            b"\342?1\n/com.databricks.rpc.RPC[CreateUploadUrlResponse]"
        )
        _CREATEUPLOADURLRESPONSE._options = None
        _CREATEUPLOADURLRESPONSE._serialized_options = (
            b"\342?%\n#com.databricks.rpc.DoNotLogContents"
        )
        _DIRECTORYENTRY._options = None
        _DIRECTORYENTRY._serialized_options = (
            b"\342?%\n#com.databricks.rpc.DoNotLogContents"
        )
        _LISTDIRECTORYRESPONSE._options = None
        _LISTDIRECTORYRESPONSE._serialized_options = (
            b"\342?%\n#com.databricks.rpc.DoNotLogContents"
        )
        _FILESYSTEMSERVICE.methods_by_name["CreateDownloadUrl"]._options = None
        _FILESYSTEMSERVICE.methods_by_name[
            "CreateDownloadUrl"
        ]._serialized_options = b"\362\206\031)\n%\n\004POST\022\027/fs/create-download-url\032\004\010\002\020\000\020\003"
    ...
    FilesystemService = service_reflection.GeneratedServiceType(
        "FilesystemService",
        (_service.Service,),
        dict(
    ...
    FilesystemService_Stub = service_reflection.GeneratedServiceStubType(
        "FilesystemService_Stub",
        (FilesystemService,),
        dict(
            DESCRIPTOR=_FILESYSTEMSERVICE,
            __module__="databricks_filesystem_service_pb2",
