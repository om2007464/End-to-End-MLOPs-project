...
if Version(google.protobuf.__version__).major >= 5:
    ...
    from . import (
        databricks_managed_catalog_messages_pb2 as databricks_managed_catalog_messages_pb2,
    )
    ...
    _builder.BuildTopDescriptorsAndMessages(
        DESCRIPTOR, "databricks_managed_catalog_service_pb2", _globals
    )
    if not _descriptor._USE_C_DESCRIPTORS:
        ...
        _globals["_DATABRICKSUNITYCATALOGSERVICE"].methods_by_name[
            "getTable"
        ]._loaded_options = None
        _globals["_DATABRICKSUNITYCATALOGSERVICE"].methods_by_name[
            "getTable"
        ]._serialized_options = b"\362\206\0316\n2\n\003GET\022%/unity-catalog/tables/{full_name_arg}\032\004\010\002\020\000\020\003"
    ...
    _DATABRICKSUNITYCATALOGSERVICE = DESCRIPTOR.services_by_name[
    ...
    if _descriptor._USE_C_DESCRIPTORS == False:
        ...
        _DATABRICKSUNITYCATALOGSERVICE.methods_by_name[
            "getTable"
        ]._serialized_options = b"\362\206\0316\n2\n\003GET\022%/unity-catalog/tables/{full_name_arg}\032\004\010\002\020\000\020\003"
        _DATABRICKSUNITYCATALOGSERVICE._serialized_start = 152
        _DATABRICKSUNITYCATALOGSERVICE._serialized_end = 330
    DatabricksUnityCatalogService = service_reflection.GeneratedServiceType(
        "DatabricksUnityCatalogService",
        (_service.Service,),
        dict(
    ...
    DatabricksUnityCatalogService_Stub = service_reflection.GeneratedServiceStubType(
        "DatabricksUnityCatalogService_Stub",
        (DatabricksUnityCatalogService,),
        dict(
            DESCRIPTOR=_DATABRICKSUNITYCATALOGSERVICE,
            __module__="databricks_managed_catalog_service_pb2",
