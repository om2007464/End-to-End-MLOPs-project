...
if Version(google.protobuf.__version__).major >= 5:
    ...
    _builder.BuildTopDescriptorsAndMessages(
        DESCRIPTOR, "unity_catalog_oss_service_pb2", _globals
    )
    if not _descriptor._USE_C_DESCRIPTORS:
        ...
        _globals["_UNITYCATALOGSERVICE"].methods_by_name[
    ...
    if _descriptor._USE_C_DESCRIPTORS == False:
        ...
        _UNITYCATALOGSERVICE.methods_by_name[
            "createRegisteredModel"
        ]._serialized_options = b"\362\206\031'\n#\n\004POST\022\025/unity-catalog/models\032\004\010\002\020\001\020\001"
    ...
    UnityCatalogService = service_reflection.GeneratedServiceType(
        "UnityCatalogService",
        (_service.Service,),
        dict(
            DESCRIPTOR=_UNITYCATALOGSERVICE, __module__="unity_catalog_oss_service_pb2"
        ),
    )

    UnityCatalogService_Stub = service_reflection.GeneratedServiceStubType(
        "UnityCatalogService_Stub",
        (UnityCatalogService,),
        dict(
            DESCRIPTOR=_UNITYCATALOGSERVICE, __module__="unity_catalog_oss_service_pb2"
        ),
