...
def _get_flavor_configuration_from_uri(model_uri, flavor_name, logger):
    ...
    try:
        ...
        try:
            ...
            ml_model_file = get_artifact_repository(
                artifact_uri=model_uri
            ).download_artifacts(artifact_path=MLMODEL_FILE_NAME)
...
def _validate_pyfunc_model_config(model_config):
    ...
    elif isinstance(model_config, dict) and all(
