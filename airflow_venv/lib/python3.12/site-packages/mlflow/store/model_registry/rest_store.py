...
_METHOD_TO_INFO = extract_api_info_for_service(
    ModelRegistryService, _REST_API_PATH_PREFIX
)
...
class RestStore(BaseRestStore):
    ...
    def get_latest_versions(self, name, stages=None):
        ...
        response_proto = self._call_endpoint(
            GetLatestVersions, req_body, call_all_endpoints=True
        )
        return [
    ...
    def search_model_versions(
        ...
        model_versions = [
            ModelVersion.from_proto(mvd) for mvd in response_proto.model_versions
        ]
    ...
    def set_registered_model_alias(self, name, alias, version):
        ...
        """
        req_body = message_to_json(
            SetRegisteredModelAlias(name=name, alias=alias, version=version)
        )
