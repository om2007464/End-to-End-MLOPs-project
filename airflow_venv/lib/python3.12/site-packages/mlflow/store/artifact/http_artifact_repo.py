...
class HttpArtifactRepository(ArtifactRepository, MultipartUploadMixin):
    ...
    def log_artifact(self, local_file, artifact_path=None):
        ...
        if (
            ...
            and os.path.getsize(local_file)
    ...
    @staticmethod
    def _upload_part(
        credential: MultipartUploadCredential, local_file, size, start_byte
    ):
    ...
    def _try_multipart_upload(self, local_file, artifact_path=None):
        ...
        try:
            ...
            self.complete_multipart_upload(
                local_file, create.upload_id, parts, artifact_path
            )
        except Exception as e:
            self.abort_multipart_upload(local_file, create.upload_id, artifact_path)
            _logger.warning(
                f"Failed to upload file {local_file} using multipart upload: {e}"
            )
            raise
