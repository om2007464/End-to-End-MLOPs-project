...
class V1alpha3DeviceRequestAllocationResult(object):
    ...
    """
    openapi_types = {"device": "str", "driver": "str", "pool": "str", "request": "str"}
    ...
    def device(self, device):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and device is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `device`, must not be `None`"
            )  # noqa: E501
    ...
    def pool(self, pool):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and pool is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `pool`, must not be `None`"
            )  # noqa: E501
