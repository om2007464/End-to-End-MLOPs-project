...
class V1alpha3ResourceClaimSpec(object):
    ...
    """
    openapi_types = {"controller": "str", "devices": "V1alpha3DeviceClaim"}

    attribute_map = {"controller": "controller", "devices": "devices"}

    def __init__(
        self, controller=None, devices=None, local_vars_configuration=None
    ):  # noqa: E501
