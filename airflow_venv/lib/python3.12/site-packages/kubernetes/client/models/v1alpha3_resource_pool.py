...
class V1alpha3ResourcePool(object):
    ...
    """
    openapi_types = {"generation": "int", "name": "str", "resource_slice_count": "int"}
    ...
    def generation(self, generation):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and generation is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `generation`, must not be `None`"
            )  # noqa: E501
    ...
    def resource_slice_count(self, resource_slice_count):
        ...
        if (
            ...
            and resource_slice_count is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `resource_slice_count`, must not be `None`"
            )  # noqa: E501
