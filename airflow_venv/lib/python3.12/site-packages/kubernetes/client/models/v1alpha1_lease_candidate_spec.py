...
class V1alpha1LeaseCandidateSpec(object):
    ...
    def lease_name(self, lease_name):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and lease_name is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `lease_name`, must not be `None`"
            )  # noqa: E501
    ...
    def preferred_strategies(self, preferred_strategies):
        ...
        if (
            ...
            and preferred_strategies is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `preferred_strategies`, must not be `None`"
            )  # noqa: E501
