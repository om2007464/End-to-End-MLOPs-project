...
class V1SleepAction(object):
    ...
    """
    openapi_types = {"seconds": "int"}

    attribute_map = {"seconds": "seconds"}
    ...
    def seconds(self, seconds):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and seconds is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `seconds`, must not be `None`"
            )  # noqa: E501
