...
class V1alpha3DeviceConstraint(object):
    ...
    """
    openapi_types = {"match_attribute": "str", "requests": "list[str]"}

    attribute_map = {"match_attribute": "matchAttribute", "requests": "requests"}

    def __init__(
        self, match_attribute=None, requests=None, local_vars_configuration=None
    ):  # noqa: E501
