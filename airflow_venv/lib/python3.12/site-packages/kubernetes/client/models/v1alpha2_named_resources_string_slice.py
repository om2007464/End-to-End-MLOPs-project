...
class V1alpha2NamedResourcesStringSlice(object):
    ...
    """
    openapi_types = {"strings": "list[str]"}

    attribute_map = {"strings": "strings"}
    ...
    def strings(self, strings):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and strings is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `strings`, must not be `None`"
            )  # noqa: E501
