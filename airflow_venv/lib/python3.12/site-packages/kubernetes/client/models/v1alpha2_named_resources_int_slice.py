...
class V1alpha2NamedResourcesIntSlice(object):
    ...
    """
    openapi_types = {"ints": "list[int]"}

    attribute_map = {"ints": "ints"}
    ...
    def ints(self, ints):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and ints is None
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `ints`, must not be `None`"
            )  # noqa: E501
