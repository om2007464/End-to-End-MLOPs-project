...
class V1alpha2VendorParameters(object):
    ...
    """
    openapi_types = {"driver_name": "str", "parameters": "object"}

    attribute_map = {"driver_name": "driverName", "parameters": "parameters"}

    def __init__(
        self, driver_name=None, parameters=None, local_vars_configuration=None
    ):  # noqa: E501
