...
class ExecProviderTest(unittest.TestCase):
    ...
    def test_error_code_returned(self, mock):
        ...
        with self.assertRaises(ConfigException) as context:
            ...
            ep.run()
        self.assertIn(
            "exec: process returned %d" % instance.wait.return_value,
    ...
    def test_nonjson_output_returned(self, mock):
        ...
        with self.assertRaises(ConfigException) as context:
            ...
            ep.run()
        self.assertIn(
            "exec: failed to decode process output", context.exception.args[0]
        )
    ...
    def test_missing_output_keys(self, mock):
        ...
        for output in outputs:
            ...
            with self.assertRaises(ConfigException) as context:
                ...
                ep.run()
            self.assertIn(
                "exec: malformed response. missing key", context.exception.args[0]
            )
