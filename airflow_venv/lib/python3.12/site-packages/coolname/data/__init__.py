...
config = {
    ...
    "adj_far": {
        ...
        "type": "nested",
        "lists": ["adjective", "adjective_first", "noun_adjective", "size"],
    },
    "adj_near": {
        "comment": "Last adjective (closest to the subject)",
        "type": "nested",
        "lists": ["adjective", "adjective_near", "noun_adjective", "prefix"],
    },
    "adj_any": {
        "comment": "The only adjective (includes everything)",
        "type": "nested",
        "lists": ["adjective", "adjective_near", "noun_adjective", "prefix", "size"],
    },
    "subj": {
        "comment": "The subject (animal)",
        "type": "nested",
        "lists": ["animal", "animal_breed", "animal_legendary"],
    },
    "of": {"type": "const", "value": "of"},
    "of_noun_any": {"type": "nested", "lists": ["of_noun", "of_noun_no_mod"]},
    ...
    "adjective_first": {"type": "words", "words": ["first", "new"], "max_length": 13},
    "adjective_near": {
        "type": "words",
        "words": [
            "almond",
    ...
    "animal_legendary": {
        "type": "words",
        "words": ["basilisk", "chupacabra", "dragon", "griffin", "pegasus", "unicorn"],
        "max_length": 13,
    },
    "from2": {
        "type": "phrases",
    ...
    "noun_adjective": {
        "type": "words",
        "words": ["fancy", "magic", "rainbow", "woodoo"],
        "max_length": 13,
    },
    "of_modifier": {
        "type": "words",
