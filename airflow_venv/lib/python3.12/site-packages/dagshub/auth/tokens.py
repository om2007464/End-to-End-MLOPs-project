...
class TokenStorage:
    ...
    def add_token(
        self,
        token: Union[str, DagshubTokenABC],
    ...
    @staticmethod
    def get_username_of_token(
        token: Union[str, Auth, DagshubTokenABC], host: str
    ) -> Optional[Dict]:
        """
    ...
    @staticmethod
    def _v1_token_list_parser(
        cache_yaml: Dict[str, Union[str, List[Dict]]]
    ) -> Dict[str, List[DagshubTokenABC]]:
        res = {}
        ...
        for host, tokens in cache_yaml.items():
            ...
            for token_dict in tokens:
                try:
                    token = token_class_map[token_dict["token_type"]].deserialize(
                        token_dict
                    )
...
def add_oauth_token(
    host: Optional[str] = None, referrer: Optional[str] = None, **kwargs
):
    """
