...
def oauth_flow(
    host: str, client_id: Optional[str] = None, referrer: Optional[str] = None
) -> OAuthDagshubToken:
    """
    ...
    auth_link = f"{dagshub_url}/authorize?state={state}&client_id={client_id}&middleman_request_id={middle_man_request_id}"
    ...
    with rich_console.status("Waiting for authorization"):
        res = httpx.post(
            ...
            data={"request_id": middle_man_request_id},
            timeout=None,
        )
