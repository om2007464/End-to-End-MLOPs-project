...
def add_voxel_annotations(
    sample: "fo.Sample", datapoint: "Datapoint", *annotation_fields: str
):
    """
        ...
        for ann in ann_dict.get("annotations", {}):
            ...
            for res in ann["result"]:
                try:
                    ...
                    logger.warning(
                        f"Couldn't convert LS annotation {ann} to voxel annotation"
                    )
