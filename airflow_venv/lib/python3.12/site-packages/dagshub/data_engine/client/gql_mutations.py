...
class GqlMutations:
    ...
    def create_datasource():
        q = (
            ...
            .query(
                "createDatasource",
                input={"name": "$name", "url": "$url", "dsType": "$dsType"},
            )
            .fields(
                [
                    "id",
    ...
    def update_metadata():
        q = (
            ...
            .query(
                "updateMetadata",
                input={"datasource": "$datasource", "datapoints": "$datapoints"},
            )
            .fields(
                [
                    "path",
    ...
    def delete_metadata_for_datapoint():
        q = (
            ...
            .operation(
                ...
                input={
                    "$datasource": "ID!",
                    "$datapoints": "[DatapointMetadataDeleteInput!]!",
                },
            )
            .query(
                "deleteMetadata",
    ...
    def update_metadata_field():
        q = (
            ...
            .query(
                ...
                input={"datasource": "$datasource", "props": "$props"},
            )
            .fields(
                [
                    "name",
    ...
    def update_metadata_params(
        datasource_id: Union[int, str], datapoints: List[Dict[str, Any]]
    ):
        return {
    ...
    def update_metadata_fields_params(
        datasource_id: Union[int, str], metadata_field_props: List[Dict[str, Any]]
    ):
    ...
    @staticmethod
    def scan_datasource_params(
        datasource_id: Union[int, str], options: Optional[List[ScanOption]]
    ):
        return {
            "id": datasource_id,
            "options": options,
    ...
    @staticmethod
    def save_dataset_params(
        datasource_id: Union[int, str], name: str, query_input: Dict[str, Any]
    ):
        return {
            "datasource": datasource_id,
            "name": name,
