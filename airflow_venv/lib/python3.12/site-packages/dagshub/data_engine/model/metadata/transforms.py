...
from dagshub.data_engine.model.metadata.validation import (
    UploadingMetadataInfo,
...
def _transform_strings_to_documents(
    ds: "Datasource", metadata: List["DatapointMetadataUpdateEntry"], field_name: str
):
    log_message(
        f"Uploading field {field_name} as a document field due to long string values"
    )
