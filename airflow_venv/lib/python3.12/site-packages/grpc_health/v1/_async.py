...
class HealthServicer(_health_pb2_grpc.HealthServicer):
    ...
    _server_status: MutableMapping[str, "_health_pb2.HealthCheckResponse.ServingStatus"]
    ...
    async def Check(self, request: _health_pb2.HealthCheckRequest, context) -> None:
    ...
    async def Watch(self, request: _health_pb2.HealthCheckRequest, context) -> None:
    ...
    async def enter_graceful_shutdown(self) -> None:
        ...
        if self._gracefully_shutting_down:
            ...
            for service in self._server_status:
                await self._set(service, _health_pb2.HealthCheckResponse.NOT_SERVING)
