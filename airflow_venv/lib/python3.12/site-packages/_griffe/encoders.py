...
def _attach_parent_to_exprs(
    obj: Class | Function | Attribute, parent: Module | Class
) -> None:
...
_loader_map: dict[
    Kind, Callable[[dict[str, Any]], Module | Class | Function | Attribute | Alias]
] = {
...
) -> dict[str, Any] | Object | Alias | Parameter | str | expressions.Expr:
