...
def parse_sphinx(
    docstring: Docstring, *, warn_unknown_params: bool = True, **options: Any
...
def _read_parameter(
    ...
    **options: Any,  # noqa: ARG001
    ...
    annotation = _determine_param_annotation(
        docstring, name, directive_type, parsed_values
    )
...
def _read_parameter_type(
    ...
    **options: Any,  # noqa: ARG001
    ...
    if len(parsed_directive.directive_parts) == 2:  # noqa: PLR2004
        ...
        docstring_warning(
            docstring, 0, f"Failed to get parameter name from '{parsed_directive.line}'"
        )
        return parsed_directive.next_index
...
def _read_attribute_type(
    ...
    **options: Any,  # noqa: ARG001
    ...
    if len(parsed_directive.directive_parts) == 2:  # noqa: PLR2004
        ...
        docstring_warning(
            docstring, 0, f"Failed to get attribute name from '{parsed_directive.line}'"
        )
        return parsed_directive.next_index
...
def _read_return(
    docstring: Docstring, offset: int, parsed_values: _ParsedValues, **options: Any
) -> int:  # noqa: ARG001
    parsed_directive = _parse_directive(docstring, offset)
    if parsed_directive.invalid:
        return parsed_directive.next_index
